...
class MainWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("BeatDeStack eXtended v3.5.0")
    ...
    def _setup_right_panel(self):
        ...
        self.btn_preview.setToolTip("Process middle 30s to check settings")
    ...
    def start_preview(self):
        ...
        self.append_log("Generating 30s preview slice...\n")
        if not create_preview_slice(file_path, temp_slice_path, duration=30):
