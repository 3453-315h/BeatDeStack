...
class TrackWidget(QFrame):
    ...
    def __init__(self, name, player, audio_output, parent=None):
    ...
    def setup_ui(self):
        ...
        # Track Name
        name_lbl = QLabel(self.name.capitalize())
...
class StemPlayerWidget(QWidget):
    ...
    def setup_ui(self):
        ...
        ctrl_frame = QFrame()
        ctrl_frame.setStyleSheet(f"background-color: {COLORS['surface']}; border-top: 1px solid #000000;")
    ...
    def load_stems(self, stem_dict):
        ...
        for name, path in stem_dict.items():
            ...
            # Create UI Widget
            widget = TrackWidget(name, player, output)
