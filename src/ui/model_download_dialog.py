...
AVAILABLE_MODELS = {
    "MDX-Net Vocals": [
        ("Kim Vocal 2", "Best vocals extraction (50 MB)", "Kim_Vocal_2.onnx"),
        ("Kim Vocal 1", "Original Kim model (50 MB)", "Kim_Vocal_1.onnx"),
        ("UVR-MDX-NET Voc FT", "Vocal fine-tuned (50 MB)", "UVR-MDX-NET-Voc_FT.onnx"),
        ("UVR-MDX-NET Karaoke 2", "Best for karaoke (50 MB)", "UVR_MDXNET_KARA_2.onnx"),
        ("UVR-MDX-NET Main", "General purpose (50 MB)", "UVR_MDXNET_Main.onnx"),
    ],
    "MDX-Net Instrumental": [
        ("UVR-MDX-NET Inst HQ 3", "High quality instrumental (50 MB)", "UVR-MDX-NET-Inst_HQ_3.onnx"),
        ("UVR-MDX-NET Inst HQ 1", "Instrumental HQ variant (50 MB)", "UVR-MDX-NET-Inst_HQ_1.onnx"),
        ("Kim Inst", "Kim instrumental model (50 MB)", "Kim_Inst.onnx"),
        ("Reverb HQ By FoxJoy", "MDX reverb removal (50 MB)", "Reverb_HQ_By_FoxJoy.onnx"),
    ],
    "MDX23C (Higher Quality)": [
        ("MDX23C-InstVoc HQ", "Vocals/Inst separation (65 MB)", "MDX23C-8KFFT-InstVoc_HQ.ckpt"),
        ("MDX23C-InstVoc HQ 2", "Improved HQ model (65 MB)", "MDX23C-8KFFT-InstVoc_HQ_2.ckpt"),
        ("MDX23C DrumSep", "Drum separation (65 MB)", "MDX23C-DrumSep-aufr33-jarredou.ckpt"),
    ],
    "Enhancement (VR Models)": [
        ("UVR-DeEcho-DeReverb", "Remove echo/reverb (180 MB)", "UVR-DeEcho-DeReverb.pth"),
        ("UVR-DeNoise", "Remove background noise (180 MB)", "UVR-DeNoise.pth"),
        ("UVR-DeNoise-Lite", "Lighter denoise (90 MB)", "UVR-DeNoise-Lite.pth"),
        ("UVR-De-Echo-Normal", "Normal echo removal (90 MB)", "UVR-De-Echo-Normal.pth"),
    ],
    "Roformer Vocals (Best 2024)": [
        ("BS-Roformer-Viperx-1297", "Best vocals SDR 12.97 (870 MB)", "model_bs_roformer_ep_317_sdr_12.9755.ckpt"),
        ("MelBand Roformer Vocals", "Kimberley Jensen vocals (450 MB)", "vocals_mel_band_roformer.ckpt"),
        ("Mel-Roformer-Viperx", "Mel-band high quality (450 MB)", "model_mel_band_roformer_ep_3005_sdr_11.4360.ckpt"),
    ],
    "Roformer Enhancement": [
        ("Mel-Roformer Denoise", "Advanced denoising (450 MB)", "denoise_mel_band_roformer_aufr33_sdr_27.9959.ckpt"),
        ("BS-Roformer De-Reverb", "Roformer reverb removal (870 MB)", "deverb_bs_roformer_8_384dim_10depth.ckpt"),
        ("Mel-Roformer Karaoke", "Best karaoke (450 MB)", "mel_band_roformer_karaoke_aufr33_viperx_sdr_10.1956.ckpt"),
    ],
}
